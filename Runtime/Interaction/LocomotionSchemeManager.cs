...
namespace Innoactive.Creator.XRInteraction
{
    ...
    ///
    /// When <see cref="MovementScheme"/>=<see cref="MoveScheme.Noncontinuous"/>,
    /// bindings (1) and (2) will be enabled, but binding (3) will be disabled.
    ///
    /// When <see cref="MovementScheme"/>=<see cref="MoveScheme.Continuous"/>,
    ...
    public class LocomotionSchemeManager : MonoBehaviour
    {
        ...
        /// </summary>
        /// <seealso cref="LocomotionSchemeManager.MovementScheme"/>
        ...
        /// </summary>
        /// <seealso cref="LocomotionSchemeManager.TurningStyle"/>
        ...
        /// </summary>
        /// <seealso cref="LocomotionSchemeManager.ForwardMovementSource"/>
        ...
        private MoveScheme movementScheme;
        /// <summary>
        /// Controls which movement control scheme to use.
        /// </summary>
        /// <seealso cref="MoveScheme"/>
        public MoveScheme MovementScheme
        {
            get => movementScheme;
            set
            {
                SetMoveScheme(value);
                movementScheme = value;
            }
        }
        ...
        private MoveForwardSource forwardMovementSource;
        /// <summary>
        /// Controls which orientation the forward direction of continuous movement is relative to.
        /// </summary>
        /// <seealso cref="MoveForwardSource"/>
        public MoveForwardSource ForwardMovementSource
        {
            get => forwardMovementSource;
            set
            {
                SetMoveForwardSource(value);
                forwardMovementSource = value;
            }
        }
        ...
        void OnEnable()
        {
            SetMoveScheme(movementScheme);
            SetTurnStyle(turningStyle);
            SetMoveForwardSource(forwardMovementSource);
        }
